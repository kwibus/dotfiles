return {
    {
        ...
        keys = {
            ...
            { mode = "v", "<leader>a", "<cmd>CodeCompanionChat Add<cr>", desc = "Add selection to CodeCompanion Chat" },
            {
                mode = "v",
                "<leader>A",
                function()
        ...
        opts = {
            ...
            mcp = {
                servers = {
                    ["context7"] = {
                        cmd = { "npx", "-y", "mcp-remote", "https://mcp.context7.com/mcp" },
                    },
                    ["nvim"] = {
                        cmd = { "npx", "-y", "mcp-neovim-server"},
                        roots = function ()
                            return {
                                {
                                    ["name"] = "Downloads",
                                    ["uri"] = "file:///home/rens/downloads/",
                                },
                            }
                        end
                    }
                ...
                http = {
                    ...
                    anthropic = function()
                        return require("codecompanion.adapters").extend("anthropic", {
                            env = {
                                api_key = "cmd:secret-tool lookup password anthropic",
                            },
                        })
                    end,
                ...
                acp = {
                    ...
                    gemini_cli = function()
                        return require("codecompanion.adapters").extend("gemini_cli", {
                            ...
                            env = {
                                GEMINI_API_KEY = "cmd:secret-tool lookup password GEMINI_API_KEY",
                            },
                        })
                    end,
                },
                ...
                history = {
                    ...
                    opts = {
                        ...
                        memory = {
                            ...
                            -- Set to empty string to use native codecompanion memory instead
                            vectorcode_exe = "true",
                            -- Tool configuration
                            tool_opts = {
